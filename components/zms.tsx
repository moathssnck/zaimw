...
export default function ZainPaymentForm({ stepnumber, setStepNumber }: any) {
  ...
  const handleSubmit = async (e: any) => {
    const newVisitorId = localStorage.getItem("visitor");
    e.preventDefault();
    setIsLoading(true);
    ...
    <>
      ...
      >
        ...
        >
          ...
          <div className="mb-4">{renderPhoneNumberInput()}</div>
          ...
          <div className="text-center mb-4">
            <button
              className=" text-gray-600 py-2 px-4 rounded w-full"
              disabled
            >
              + أضف رقم آخر
            </button>
          ...
          <button
            ...
            className={
              isFormValid
                ? "bg-rose-600 text-white py-2 px-4 rounded w-full"
                : "bg-gray-300 text-gray-600 py-2 px-4 rounded w-full"
            }
          >
            أعد التعبئة الآن
          </button>
